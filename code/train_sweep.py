...
if __name__ == "__main__":
    ...
    'parameters': 
    {
        'learning_rate': {'max': 0.1, 'min': .00001},
        'early_stopping_patience': {'values': [3, 5, 7, 9]}
     }}

    sweep_id = wandb.sweep(sweep=sweep_configuration, project="<Lv2-KLUE>")

    wandb.agent(sweep_id, function=main, count=10) #sweep configuration, main 함수를 10번 실행하겠다!
